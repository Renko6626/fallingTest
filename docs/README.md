...
3. **M2 反应表与燃烧**（spec 已就绪：`superpowers/specs/2026-08-31-m2-reactions-and-fire-design.md`，Status: Proposed；Layer G 三 Task 之后；**2026-08-31 重定义**——Layer F 场层已删除，见总纲 §11 翻案记录第 6 条：
